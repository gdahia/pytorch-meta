"""Prototpyical networks utilities."""
import torch
...
def get_right(prototypes, embeddings, targets):
  """Compute the number of right examples of the prototypical network on the
  test/query points.
  ...
  return torch.sum(predictions.eq(targets))
